            ...
            while($row = $result->fetch_assoc()){
              ...
              <tr>
                ...
                <td>
                  ...
                  ?>
                  <form method="post">
                    <button type="button" name='button' id="<?php echo $row['email'];?>" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal" onclick="document.getElementById('pEliminazione').value='<?php echo $row['email'];?>';">
