      ...
      <table id="table" class="table col-xs-12">
        ...
        while($row = $result->fetch_assoc()){
          ...
          <tr>
            ...
            <td class="col-xs-2">
              <button type="button" name='button' id="" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal" onclick="document.getElementById('removeClasse').value='<?php echo $row['cla_id'];?>';">
